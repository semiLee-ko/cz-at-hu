        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="share-section">
                    ...
                    <p class="hint">링크를 복사해서 메신저로 보내세요!</p>
                    <div class="url-box">
                        <input type="text" readonly value="${shareUrl}" id="shareUrlInput">
                        <button class="btn-primary-modal" id="btnCopyUrl" title="링크 복사">
                ...
                <div class="share-section">
                    ...
                    <p class="hint">JSON 파일을 다운로드해서 공유할 수도 있어요</p>
                    <button class="btn-secondary-modal" id="btnDownloadJson">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="modal-body">
                ...
                <div class="share-section">
                    ...
                    <div class="url-box">
                        ...
                        <button class="btn-primary-modal" id="btnImportUrl" title="가져오기">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                                <polyline points="7 10 12 15 17 10"></polyline>
                                <line x1="12" y1="15" x2="12" y2="3"></line>
                ...
                <div class="share-section">
                    ...
                    <button class="btn-secondary-modal" id="btnSelectFile">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path>
                        </svg>
                        파일 선택하기
